...
#define MVE                 ((arm_v8m_cm55_mve_regs_t *)MVE_BASE)

/*============================================================================*
 * MVE Implementation
 *============================================================================*/

uint32_t arm_v8m_cm55_mve_is_present(void)
{
    /* TODO: Check MVFR0/1/2 for MVE support */
    return 0;
}

uint32_t arm_v8m_cm55_mve_has_int(void)
{
    /* TODO: Check MVFR1 for MVE integer support */
    return 0;
}

uint32_t arm_v8m_cm55_mve_has_fp(void)
{
    /* TODO: Check MVFR1 for MVE floating-point support */
    return 0;
}

void arm_v8m_cm55_mve_enable(void)
{
    /* TODO: Enable MVE in CPACR */
}

void arm_v8m_cm55_mve_disable(void)
{
...
void arm_v8m_cm55_mve_vldm(uint32_t *addr, uint32_t num_regs)
{
...
void arm_v8m_cm55_mve_vstm(uint32_t *addr, uint32_t num_regs)
{
...
void arm_v8m_cm55_mve_set_vpr(uint32_t value)
{
    /* TODO: Write to VPR register */
    (void)value;
}

uint32_t arm_v8m_cm55_mve_get_vpr(void)
{
    /* TODO: Read VPR register */
    return 0;
}

void arm_v8m_cm55_mve_set_fpscr(uint32_t value)
{
    /* TODO: Write to FPSCR register */
    (void)value;
}

uint32_t arm_v8m_cm55_mve_get_fpscr(void)
{
...
void arm_v8m_cm55_mve_set_lpstart(uint32_t addr)
{
    /* TODO: Write to LPSTART register */
    (void)addr;
}

void arm_v8m_cm55_mve_set_lpend(uint32_t addr)
{
    /* TODO: Write to LPEND register */
    (void)addr;
}

void arm_v8m_cm55_mve_set_lpcnt(uint32_t count)
{
