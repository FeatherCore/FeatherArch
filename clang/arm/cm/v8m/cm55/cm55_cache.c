...
#define CACHE               ((arm_v8m_cm55_cache_regs_t *)CACHE_BASE)
#define CACHE_ID            ((arm_v8m_cm55_cache_id_regs_t *)(CACHE_ID_BASE + 0x80))

/*============================================================================*
 * I-Cache Operations
 *============================================================================*/

void arm_v8m_cm55_iciallu(void)
{
    /* TODO: Execute ICIALLU instruction to invalidate all I-Cache */
}

void arm_v8m_cm55_icimvau(uint32_t addr)
{
...
void arm_v8m_cm55_icache_invalidate_line(uint32_t addr)
{
...
void arm_v8m_cm55_dcache_invalidate_line(uint32_t addr)
{
    /* TODO: Execute DCIMVAC */
    (void)addr;
}

void arm_v8m_cm55_dcache_clean_line(uint32_t addr)
{
    /* TODO: Execute DCCMVAC */
    (void)addr;
}

void arm_v8m_cm55_dcache_clean_invalidate_line(uint32_t addr)
{
...
uint32_t arm_v8m_cm55_cache_get_ccsidr(void)
{
    /* TODO: Read CCSIDR register */
    return 0;
}

void arm_v8m_cm55_cache_set_csselr(uint32_t level)
{
    /* TODO: Write CSSELR register */
    (void)level;
}

uint32_t arm_v8m_cm55_cache_get_csselr(void)
{
...
void arm_v8m_cm55_bpiall(void)
{
    /* TODO: Execute BPIALL instruction to invalidate all branch predictors */
}

void arm_v8m_cm55_bpimva(uint32_t addr)
{
