...
#define MPU                 ((arm_v8m_cm33_mpu_regs_t *)MPU_BASE)

/*============================================================================*
 * MPU Implementation
 *============================================================================*/

void arm_v8m_cm33_mpu_enable(void)
{
    /* TODO: Set ENABLE bit in MPU_CTRL, may need DSB/ISB */
}

void arm_v8m_cm33_mpu_disable(void)
{
    /* TODO: Clear ENABLE bit in MPU_CTRL, may need DSB/ISB */
}

uint32_t arm_v8m_cm33_mpu_get_region_count(void)
{
    /* TODO: Read DREGION field from MPU_TYPE */
    return 0;
}

void arm_v8m_cm33_mpu_select_region(uint32_t region_num)
{
    /* TODO: Write to MPU_RNR */
    (void)region_num;
}

void arm_v8m_cm33_mpu_set_region(uint32_t base_addr, uint32_t limit_addr, uint32_t attrs)
{
...
void arm_v8m_cm33_mpu_disable_region(uint32_t region_num)
{
    /* TODO: Disable region by clearing ENABLE bit in RLAR */
    (void)region_num;
}

void arm_v8m_cm33_mpu_set_mair(uint32_t attr_idx, uint32_t attr)
{
...
uint32_t arm_v8m_cm33_mpu_get_mair(uint32_t attr_idx)
{
...
void arm_v8m_cm33_mpu_enable_s(void)
{
    /* TODO: Set ENABLE bit in MPU_CTRL_S from secure state */
}

void arm_v8m_cm33_mpu_disable_s(void)
{
    /* TODO: Clear ENABLE bit in MPU_CTRL_S from secure state */
}

void arm_v8m_cm33_mpu_set_region_s(uint32_t base_addr, uint32_t limit_addr, uint32_t attrs)
{
