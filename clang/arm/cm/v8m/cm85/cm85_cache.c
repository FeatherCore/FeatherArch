...
void cm85_cache_iciallu(void)
{
    /* TODO: Invalidate all I-cache */
}

void cm85_cache_icimvau(uint32_t addr)
{
    /* TODO: Invalidate I-cache line by address */
    (void)addr;
}

void cm85_cache_dcimvac(uint32_t addr)
{
    /* TODO: Invalidate D-cache line by address to PoC */
    (void)addr;
}

void cm85_cache_dcisw(uint32_t setway)
{
    /* TODO: Invalidate D-cache line by set/way */
    (void)setway;
}

void cm85_cache_dccmvau(uint32_t addr)
{
    /* TODO: Clean D-cache line by address to PoU */
    (void)addr;
}

void cm85_cache_dccmvac(uint32_t addr)
{
    /* TODO: Clean D-cache line by address to PoC */
    (void)addr;
}

void cm85_cache_dccsw(uint32_t setway)
{
    /* TODO: Clean D-cache line by set/way */
    (void)setway;
}

void cm85_cache_dccimvac(uint32_t addr)
{
    /* TODO: Clean and Invalidate D-cache line by address to PoC */
    (void)addr;
}

void cm85_cache_dccisw(uint32_t setway)
{
