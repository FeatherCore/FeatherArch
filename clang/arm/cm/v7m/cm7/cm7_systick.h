...
static inline void arm_v7m_cm7_systick_init(uint32_t reload_value) {
    arm_v7m_systick_init(reload_value);
}

static inline void arm_v7m_cm7_systick_enable(void) {
    arm_v7m_systick_enable();
}

static inline void arm_v7m_cm7_systick_disable(void) {
    arm_v7m_systick_disable();
}

static inline uint32_t arm_v7m_cm7_systick_get_count(void) {
    return arm_v7m_systick_get_count();
}

static inline void arm_v7m_cm7_systick_set_reload(uint32_t value) {
    arm_v7m_systick_set_reload(value);
}

static inline uint32_t arm_v7m_cm7_systick_get_reload(void) {
    return arm_v7m_systick_get_reload();
}

static inline uint32_t arm_v7m_cm7_systick_get_calib(void) {
