...
#define DEBUG               ((arm_v7m_cm7_debug_regs_t *)DEBUG_BASE)
#define DWT                 ((arm_v7m_cm7_dwt_regs_t *)DWT_BASE)
#define FPB                 ((arm_v7m_cm7_fpb_regs_t *)FPB_BASE)
#define CTI                 ((arm_v7m_cm7_cti_regs_t *)CTI_BASE)

/*============================================================================*
 * Debug Implementation
 *============================================================================*/

void arm_v7m_cm7_debug_enable_trace(void)
{
    /* TODO: Enable TRCENA in DEMCR */
}

void arm_v7m_cm7_debug_disable_trace(void)
{
    /* TODO: Disable TRCENA in DEMCR */
}

uint32_t arm_v7m_cm7_debug_is_halted(void)
{
...
void arm_v7m_cm7_dwt_enable_cyccnt(void)
{
    /* TODO: Enable CYCCNTENA in DWT_CTRL */
}

void arm_v7m_cm7_dwt_disable_cyccnt(void)
{
    /* TODO: Disable CYCCNTENA in DWT_CTRL */
}

uint32_t arm_v7m_cm7_dwt_get_cyccnt(void)
{
    /* TODO: Read DWT_CYCCNT */
    return 0;
}

void arm_v7m_cm7_dwt_set_cyccnt(uint32_t value)
{
    /* TODO: Write DWT_CYCCNT */
    (void)value;
}

void arm_v7m_cm7_dwt_enable_exception_trace(void)
{
    /* TODO: Enable EXCTRCENA in DWT_CTRL */
}

void arm_v7m_cm7_dwt_enable_pc_sampling(uint32_t interval)
{
...
void arm_v7m_cm7_fpb_enable(void)
{
    /* TODO: Set ENABLE bit in FPB_CTRL */
}

void arm_v7m_cm7_fpb_disable(void)
{
    /* TODO: Clear ENABLE bit in FPB_CTRL */
}

void arm_v7m_cm7_fpb_set_breakpoint(uint32_t comp_id, uint32_t addr)
{
...
void arm_v7m_cm7_fpb_clear_breakpoint(uint32_t comp_id)
{
