...
#define SYSTICK             ((arm_v7m_cm7_systick_regs_t *)SYSTICK_BASE)

/*============================================================================*
 * SysTick Implementation
 *============================================================================*/

void arm_v7m_cm7_systick_init(uint32_t reload_value)
{
    /* TODO: Configure and enable SysTick */
    (void)reload_value;
}

void arm_v7m_cm7_systick_enable(void)
{
    /* TODO: Set ENABLE bit in CTRL register */
}

void arm_v7m_cm7_systick_disable(void)
{
    /* TODO: Clear ENABLE bit in CTRL register */
}

uint32_t arm_v7m_cm7_systick_get_count(void)
{
    /* TODO: Read VAL register */
    return 0;
}

void arm_v7m_cm7_systick_set_reload(uint32_t value)
{
    /* TODO: Write LOAD register */
    (void)value;
}

uint32_t arm_v7m_cm7_systick_get_reload(void)
{
    /* TODO: Read LOAD register */
    return 0;
}

uint32_t arm_v7m_cm7_systick_get_calib(void)
{
