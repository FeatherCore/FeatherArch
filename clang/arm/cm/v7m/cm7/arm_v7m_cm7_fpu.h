...
static inline void arm_v7m_cm7_fpu_enable(void) {
    arm_v7m_fpu_enable();
}

static inline void arm_v7m_cm7_fpu_disable(void) {
    arm_v7m_fpu_disable();
}

static inline uint32_t arm_v7m_cm7_fpu_is_present(void) {
    return arm_v7m_fpu_is_present();
}

static inline void arm_v7m_cm7_fpu_set_auto_save(uint32_t enable) {
    arm_v7m_fpu_set_auto_save(enable);
}

static inline void arm_v7m_cm7_fpu_lazy_stacking_enable(void) {
    arm_v7m_fpu_lazy_stacking_enable();
}

static inline void arm_v7m_cm7_fpu_lazy_stacking_disable(void) {
    arm_v7m_fpu_lazy_stacking_disable();
}

static inline void arm_v7m_cm7_fpu_set_default_fpccr(uint32_t value) {
