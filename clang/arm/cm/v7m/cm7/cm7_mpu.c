...
#define MPU                 ((arm_v7m_cm7_mpu_regs_t *)MPU_BASE)

/*============================================================================*
 * MPU Implementation
 *============================================================================*/

void arm_v7m_cm7_mpu_enable(void)
{
...
uint32_t arm_v7m_cm7_mpu_get_region_count(void)
{
    /* TODO: Read DREGION field from MPU_TYPE */
    return 0;
}

void arm_v7m_cm7_mpu_select_region(uint32_t region_num)
{
    /* TODO: Write to MPU_RNR */
    (void)region_num;
}

void arm_v7m_cm7_mpu_set_region(uint32_t base_addr, uint32_t size, uint32_t attrs)
{
