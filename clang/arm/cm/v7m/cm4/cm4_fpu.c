...
#define FPU                 ((arm_v7m_cm4_fpu_regs_t *)FPU_BASE)
...
uint32_t arm_v7m_cm4_fpu_is_present(void)
{
    /* TODO: Check MVFR0 for floating-point support */
    return 0;
}

void arm_v7m_cm4_fpu_set_auto_save(uint32_t enable)
{
    /* TODO: Configure ASPEN bit in FPCCR */
    (void)enable;
}

void arm_v7m_cm4_fpu_lazy_stacking_enable(void)
{
    /* TODO: Set LSPEN bit in FPCCR */
}

void arm_v7m_cm4_fpu_lazy_stacking_disable(void)
{
    /* TODO: Clear LSPEN bit in FPCCR */
}

void arm_v7m_cm4_fpu_set_default_fpccr(uint32_t value)
{
