...
#define DEBUG               ((arm_v7m_debug_regs_t *)DEBUG_BASE)
#define DWT                 ((arm_v7m_dwt_regs_t *)DWT_BASE)

/*============================================================================*
 * Debug Implementation
 *============================================================================*/

void arm_v7m_debug_enable_trace(void)
{
    /* TODO: Enable TRCENA in DEMCR */
}

void arm_v7m_debug_disable_trace(void)
{
    /* TODO: Disable TRCENA in DEMCR */
}

uint32_t arm_v7m_debug_is_halted(void)
{
...
void arm_v7m_dwt_enable_cyccnt(void)
{
    /* TODO: Enable CYCCNTENA in DWT_CTRL */
}

uint32_t arm_v7m_dwt_get_cyccnt(void)
{
    /* TODO: Read DWT_CYCCNT */
    return 0;
}

void arm_v7m_dwt_set_cyccnt(uint32_t value)
{
