 ...
 *
 * ============================================================================
 * File: armv8m_systick.h
 * Description: ARMv8-M SysTick timer definitions and function declarations
 * 描述: ARMv8-M SysTick 定时器定义和函数声明
 *
...
#ifndef __ARCH_ARM_V8M_SYSTICK_H__
#define __ARCH_ARM_V8M_SYSTICK_H__
...
#endif /* __ARCH_ARM_V8M_SYSTICK_H__ */
