 ...
 * ============================================================================
 * File: armv8-m_tpiu.h
 * Description: ARMv8-M TPIU definitions
 * 描述: ARMv8-M 跟踪端口接口单元定义
 *
...
#ifndef __ARCH_ARM_V8M_TPIU_H__
#define __ARCH_ARM_V8M_TPIU_H__
 ...
 * TPIU 支持的并行端口大小寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.1.31
 */
...
/**
 * TPIU Periodic Synchronization Control Register (TPIU_PSCR)
 * TPIU 周期性同步控制寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.1.31
 */
#define TPIU_PSCR                (*(volatile uint32_t *)(TPIU_BASE_ADDR + 0x308))
