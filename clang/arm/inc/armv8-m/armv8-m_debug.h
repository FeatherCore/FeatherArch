 ...
 * ============================================================================
 * File: armv8m_debug.h
 * Description: ARMv8-M debug and trace component definitions
 * 描述: ARMv8-M 调试和跟踪组件定义
 *
...
#ifndef __ARCH_ARM_V8M_DEBUG_H__
#define __ARCH_ARM_V8M_DEBUG_H__
 ...
 * DWT 控制寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.58
 */
 ...
 * DWT 周期计数寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.59
 */
 ...
 * DWT CPI计数寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.57
 */
 ...
 * DWT 异常开销计数寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.62
 */
 ...
 * DWT LSU计数寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.67
 */
 ...
 * DWT 折叠指令计数寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.63
 */
 ...
 * DWT 程序计数器采样寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.68
 */
 ...
 * DWT 比较器寄存器n
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.56
 */
 ...
 * DWT 比较器功能寄存器n
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.64
 */
 ...
 * DWT 软件锁访问寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.65
 */
 ...
 * DWT 软件锁状态寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.66
 */
 ...
 * DWT 设备架构寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.60
 */
 ...
 * DWT 设备类型寄存器
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.61
 */
 ...
 * DWT 外设标识寄存器0
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.69
 */
 ...
 * DWT 外设标识寄存器1
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.70
 */
 ...
 * DWT 外设标识寄存器2
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.71
 */
 ...
 * DWT 外设标识寄存器3
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.72
 */
 ...
 * DWT 组件标识寄存器0
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.52
 */
 ...
 * DWT 组件标识寄存器1
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.53
 */
 ...
 * DWT 组件标识寄存器2
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.54
 */
 ...
 * DWT 组件标识寄存器3
 * Reference: Arm(R) v8-M Architecture Reference Manual, D1.2.55
 */
...
#endif /* __ARCH_ARM_V8M_DEBUG_H__ */
