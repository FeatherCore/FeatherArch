...
/// Cortex-M55 revision
pub const ____CM55_REV_REV: u32 = 0x0000;
/// Number of priority bits
pub const __NVIC_PRIO_BITS: u32 = 5;
/// Use vendor specific SysTick config
pub const __Vendor_SysTickConfig: u32 = 0;
/// MVE (Helium) present
pub const __ARM_FEATURE_MVE: u32 = 1;

/* ========================================================================= */
/* ============                 Processor Id               ============ */
/* ========================================================================= */

/// Processor Family: Cortex-M55
pub const CMSIS_CPU: &str = "Cortex-M55";
...
pub const SecureFault_IRQn: i32 = -7;
/// SV Call Interrupt
...
/**
 * \brief Union type to access the Floating Point Status and Control Register (FPSCR).
 */
#[repr(C)]
...
#[derive(Default, Clone, Copy)]
pub struct FPSCR_b {
    /// bit:  0..15  Exception flags
    pub IOC: u32,
    /// bit: 16..23  Reserved
    pub _reserved0: u32,
    /// bit:     24  Input Denormal exception flag
    pub IDC: u32,
    /// bit:     25  Inexact exception flag
    pub IXC: u32,
    /// bit:     26  Underflow exception flag
    pub UFC: u32,
    /// bit:     27  Overflow exception flag
    pub OFC: u32,
    /// bit:     28  Division by Zero exception flag
    pub DZC: u32,
    /// bit:     29  Invalid Operation exception flag
    pub IOC_bit: u32,
    /// bit:     30  Default NaN mode
    pub DN: u32,
    /// bit:     31  Flush to Zero mode
    pub FZ: u32,
}

/** \brief FPSCR Register Definitions */
pub const FPSCR_FZ_Pos: u32 = 31;
pub const FPSCR_FZ_Msk: u32 = 1 << FPSCR_FZ_Pos;
pub const FPSCR_DN_Pos: u32 = 30;
pub const FPSCR_DN_Msk: u32 = 1 << FPSCR_DN_Pos;
pub const FPSCR_IOC_Pos: u32 = 29;
pub const FPSCR_IOC_Msk: u32 = 1 << FPSCR_IOC_Pos;
pub const FPSCR_DZC_Pos: u32 = 28;
pub const FPSCR_DZC_Msk: u32 = 1 << FPSCR_DZC_Pos;
pub const FPSCR_OFC_Pos: u32 = 27;
pub const FPSCR_OFC_Msk: u32 = 1 << FPSCR_OFC_Pos;
pub const FPSCR_UFC_Pos: u32 = 26;
pub const FPSCR_UFC_Msk: u32 = 1 << FPSCR_UFC_Pos;
pub const FPSCR_IXC_Pos: u32 = 25;
pub const FPSCR_IXC_Msk: u32 = 1 << FPSCR_IXC_Pos;
pub const FPSCR_IDC_Pos: u32 = 24;
pub const FPSCR_IDC_Msk: u32 = 1 << FPSCR_IDC_Pos;
...
/// ICB Coprocessor Power Control Register Definitions
pub const ICB_CPPWR_SUS11_Pos: u32 = 23;
pub const ICB_CPPWR_SUS11_Msk: u32 = 1 << ICB_CPPWR_SUS11_Pos;
pub const ICB_CPPWR_SU11_Pos: u32 = 22;
pub const ICB_CPPWR_SU11_Msk: u32 = 1 << ICB_CPPWR_SU11_Pos;
pub const ICB_CPPWR_SUS10_Pos: u32 = 21;
pub const ICB_CPPWR_SUS10_Msk: u32 = 1 << ICB_CPPWR_SUS10_Pos;
pub const ICB_CPPWR_SU10_Pos: u32 = 20;
pub const ICB_CPPWR_SU10_Msk: u32 = 1 << ICB_CPPWR_SU10_Pos;

/// ICB Auxiliary Control Register Definitions
pub const ICB_ACTLR_DISCRITAXIRUW_Pos: u32 = 27;
pub const ICB_ACTLR_DISCRITAXIRUW_Msk: u32 = 1 << ICB_ACTLR_DISCRITAXIRUW_Pos;
pub const ICB_ACTLR_DISDI_Pos: u32 = 16;
pub const ICB_ACTLR_DISDI_Msk: u32 = 3 << ICB_ACTLR_DISDI_Pos;
pub const ICB_ACTLR_DISCRITAXIRUR_Pos: u32 = 15;
pub const ICB_ACTLR_DISCRITAXIRUR_Msk: u32 = 1 << ICB_ACTLR_DISCRITAXIRUR_Pos;
pub const ICB_ACTLR_EVENTBUSEN_Pos: u32 = 14;
pub const ICB_ACTLR_EVENTBUSEN_Msk: u32 = 1 << ICB_ACTLR_EVENTBUSEN_Pos;
pub const ICB_ACTLR_EVENTBUSEN_S_Pos: u32 = 13;
pub const ICB_ACTLR_EVENTBUSEN_S_Msk: u32 = 1 << ICB_ACTLR_EVENTBUSEN_S_Pos;
pub const ICB_ACTLR_DISITMATBFLUSH_Pos: u32 = 12;
pub const ICB_ACTLR_DISITMATBFLUSH_Msk: u32 = 1 << ICB_ACTLR_DISITMATBFLUSH_Pos;
pub const ICB_ACTLR_DISNWAMODE_Pos: u32 = 11;
pub const ICB_ACTLR_DISNWAMODE_Msk: u32 = 1 << ICB_ACTLR_DISNWAMODE_Pos;
pub const ICB_ACTLR_FPEXCODIS_Pos: u32 = 10;
pub const ICB_ACTLR_FPEXCODIS_Msk: u32 = 1 << ICB_ACTLR_FPEXCODIS_Pos;
pub const ICB_ACTLR_DISOLAP_Pos: u32 = 7;
pub const ICB_ACTLR_DISOLAP_Msk: u32 = 1 << ICB_ACTLR_DISOLAP_Pos;
pub const ICB_ACTLR_DISOLAPS_Pos: u32 = 6;
pub const ICB_ACTLR_DISOLAPS_Msk: u32 = 1 << ICB_ACTLR_DISOLAPS_Pos;
pub const ICB_ACTLR_DISLOBR_Pos: u32 = 5;
pub const ICB_ACTLR_DISLOBR_Msk: u32 = 1 << ICB_ACTLR_DISLOBR_Pos;
pub const ICB_ACTLR_DISLO_Pos: u32 = 4;
pub const ICB_ACTLR_DISLO_Msk: u32 = 1 << ICB_ACTLR_DISLO_Pos;
pub const ICB_ACTLR_DISLOLEP_Pos: u32 = 3;
pub const ICB_ACTLR_DISLOLEP_Msk: u32 = 1 << ICB_ACTLR_DISLOLEP_Pos;
pub const ICB_ACTLR_DISFOLD_Pos: u32 = 2;
pub const ICB_ACTLR_DISFOLD_Msk: u32 = 1 << ICB_ACTLR_DISFOLD_Pos;

/// ICB Interrupt Controller Type Register Definitions
pub const ICB_ICTR_INTLINESNUM_Pos: u32 = 0;
pub const ICB_ICTR_INTLINESNUM_Msk: u32 = 0xF << ICB_ICTR_INTLINESNUM_Pos;
...
/// ICB Base Address
pub const ICB_BASE: u32 = SCS_BASE + 0x0004;
/// ITM Base Address
