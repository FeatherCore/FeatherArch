...
/*
 * CMSIS STAR-MC1 Core Peripheral Access Layer Header File
 */
...
/// Processor Family: STAR-MC1
pub const CMSIS_CPU: &str = "STAR-MC1";
...
/// Structure type to access the Engineering Parameters.
#[repr(C)]
#[derive(Default, Clone, Copy)]
pub struct EMSS_Type {
...
/// EMSS Base Address
pub const EMSS_BASE: u32 = SCS_BASE + 0x0300;
