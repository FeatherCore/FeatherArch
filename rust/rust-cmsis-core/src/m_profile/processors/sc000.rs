...
/// VTOR not present
pub const __VTOR_PRESENT: u32 = 0;
/// SC000 revision
pub const __SC000_REV: u32 = 0x0000;
...
/// Processor Family: SC000
pub const CMSIS_CPU: &str = "SC000";
...
pub struct SCB_Type {
    ...
    pub ICSR: u32,
    /// Offset: 0x008 (R/W)  Vector Table Offset Register (only supported with __VTOR_PRESENT)
    pub VTOR: u32,
...
/// Security Features Control Register Base Address
pub const SCnSCB_BASE: u32 = SCS_BASE;

/// Interrupt Priorities are WORD accessible only under Armv6-M
/// The following MACROS handle generation of the register offset and byte masks
#[inline(always)]
pub const fn _BIT_SHIFT(IRQn: i32) -> u32 {
    ((((IRQn as u32)) & 0x03) * 8)
}

#[inline(always)]
pub const fn _SHP_IDX(IRQn: i32) -> u32 {
    (((((IRQn as u32) & 0x0F) - 8) >> 2))
}

#[inline(always)]
pub const fn _IP_IDX(IRQn: i32) -> u32 {
    ((IRQn as u32) >> 2)
}
